...
ButtonStyle {
    ...
    property double dct_radius: control.hasOwnProperty("dct_radius") ? control.dct_radius : 2
    property double dct_fontPixelSize: control.hasOwnProperty("dct_fontPixelSize") ? control.dct_fontPixelSize : 13
    property string dct_fontFamily: control.hasOwnProperty("dct_fontFamily") ? control.dct_fontFamily : "Roboto"
    ...
    label: Item {
        ...
        Label {
            ...
            font.family: dct_fontFamily
            font.pixelSize: dct_fontPixelSize
            //style: "title"
